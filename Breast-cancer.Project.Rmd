...
gene_proteins <- read.csv("/Users/sheetalnighut/Desktop/cancer-project/PAM50_proteins.csv")
...
```{r}
clinical <- read.csv("/Users/sheetalnighut/Desktop/cancer-project/clinical_data_breast_cancer.csv")
...
```{r}
proteomes <- read.csv("/Users/sheetalnighut/Desktop/cancer-project/77_cancer_proteomes_CPTAC_itraq.csv")
